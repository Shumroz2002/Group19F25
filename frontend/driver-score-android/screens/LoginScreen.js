...
// Complete any pending auth sessions (for web support)
...
export default function LoginScreen({ navigation }) {
  ...
  const [request, response, promptAsync] = Google.useAuthRequest({
    ...
    // TODO: Add your iOS Client ID here (Required for iOS)
    iosClientId: "YOUR_IOS_CLIENT_ID.apps.googleusercontent.com",
    // TODO: Add your Android Client ID here (Required for Android)
          ...
          <View style={styles.card}>
            ...
            >
              <Text style={styles.registerLinkText}>
                ...
                <Text style={styles.registerLinkUnderline}>Register</Text>
              </Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
